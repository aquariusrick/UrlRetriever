...
'use strict';
    ...
    var UrlResult = Backbone.Model.extend({
            defaults: {
                url: "",
                content: "",
                selectedTag: null,
        ...
        // Summary view
        UrlSummaryView = Backbone.View.extend({
            el: "div.url_summary",
        ...
        // Code View
        UrlResultView = Backbone.View.extend({
            el: "div.url_detail",
            events: {},
            ...
            render: function() {
                var content = this.highlight_tags(this.model.get("content"), this.model.get('selectedTag'));
            ...
            highlight_tags: function(searchString, tagName) {
                if (!tagName)
